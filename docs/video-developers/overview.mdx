...
workflow. There are many use cases for Livepeer and the community is excited to
see what you build. If you get stuck introduce yourself in the
[#broadcasting](https://discord.gg/8Vr6B2qERb) discord channel and the community
...
> access to the Livepeer network and a traditional payment rail check out
