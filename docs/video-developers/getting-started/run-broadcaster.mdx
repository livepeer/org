...
sure to change the network to "mainnet". Learn more about supported networks, including "mainet" and Rinkeby, [here](/docs/installation/connect-to-ethereum#supported-networks). 
