...
Since we're using the Rinkeby test network for this tutorial you'll need acquire
...
Upon selecting the option, you should be prompted to entre the amount of ETH to
