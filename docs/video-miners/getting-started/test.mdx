...
- Make sure you have [activated your
  orchestrator](/docs/video-miners/getting-started/activation
...
[here](/docs/video-miner/reference/leaderboard).
...
<Pagination
  ...
  nextStep={{
    ...
    href: "/docs/video-miners/getting-started/calling-reward",
  }}
/>
