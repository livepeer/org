...
ETH and LPT funds should both be sent to the ETH Account showing in livepeer_cli

*-----------------------------*--------------------------------------------*
|                 ETH Account |                                            |
*-----------------------------*--------------------------------------------*

Do NOT send LPT to the LivepeerToken Address otherwise you will lose your funds
