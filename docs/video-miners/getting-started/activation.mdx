...
- Make sure you have `livepeer`
  [installed](https://github.com/livepeer/go-livepeer/blob/master/doc/install.md)
- Make sure you have access to an
  [Ethereum JSON-RPC URL](https://github.com/livepeer/go-livepeer/blob/master/doc/ethereum.md)
...
- ETH to pay for transaction fees. Recommendation: start with a small amount and
...
<div
  ...
  <NextStep href="/docs/video-miners/getting-started/test" title="Test" />
  <NextStep href="/docs/video-miners/getting-started/test" title="Test" />
</div>
