...
[getting started section](../getting-started/overview.md). Given these modes of
operation, video miners can consider different architectures. Two of the most
...
about the latter, see the [transcoding pools](./pools.md) section. Some of the
