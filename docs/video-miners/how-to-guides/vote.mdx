...
1. Find the contract address for the poll in the explorer page for the poll.
   ...
   ![PollDetailView](https://user-images.githubusercontent.com/5933273/112392207-6a089b80-8ccf-11eb-9e16-15983dc02654.png)

   The poll page will include the following box:

   ![LivepeerCLIVoteCTA](https://user-images.githubusercontent.com/5933273/112392205-6a089b80-8ccf-11eb-8221-41ca199e9449.png)

   Click the "Follow the instructions" link to display the instructions for
   voting with `livepeer_cli`:

   ![LivepeerCLIVoteInstructions](https://user-images.githubusercontent.com/5933273/112392206-6a089b80-8ccf-11eb-9468-bf920990262d.png)
...
<Pagination
  previousStep={{
    title: "Dual Mine",
    href: "/docs/video-miners/how-to-guides/dual-mining",
  }}
  nextStep={{
    title: "Troubleshoot",
