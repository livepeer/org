...
Planning to develop a project on Livepeer? Begin building, connect with them,
and secure funding!
...
<Button variant="neutral">Submit Proposal</Button>
...
<Button variant="neutral">Connect</Button>

<br />
<br />

## Livepeer Streaming Credits Program

Livepeer Inc, the founding team behind the Livepeer Protocol, provides Livepeer
streaming credits to eligable builders.

<Button variant="neutral">Apply for streaming credits</Button>
