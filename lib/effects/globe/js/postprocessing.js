...
(function (global, factory) {
      ...
      _this13 = _super13.call(this, {
        ...
        uniforms: {
          ...
          range: new three.Uniform(
            useRange ? luminanceRange : new three.Vector2()
          ),
        },
  ...
  var fragmentShader$b =
    'uniform sampler2D inputBuffer;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 c0=texture2D(inputBuffer,vUv0).rg;vec2 c1=texture2D(inputBuffer,vUv1).rg;vec2 c2=texture2D(inputBuffer,vUv2).rg;vec2 c3=texture2D(inputBuffer,vUv3).rg;float d0=(c0.x-c1.x)*0.5;float d1=(c2.x-c3.x)*0.5;float d=length(vec2(d0,d1));float a0=min(c0.y,c1.y);float a1=min(c2.y,c3.y);float visibilityFactor=min(a0,a1);gl_FragColor.rg=(1.0-visibilityFactor>0.001)? vec2(d,0.0): vec2(0.0,d);}';
  var vertexShader$5 =
    ...
    function Resizer(resizable) {
      ...
      var height =
        arguments.length > 2 && arguments[2] !== undefined
          ...
          : AUTO_SIZE;
      var scale =
        arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1.0;
  ...
  var BlurPass = (function (_Pass) {
    ...
    function BlurPass() {
      ...
      var _ref =
        ...
        resolutionScale =
          _ref$resolutionScale === void 0 ? 0.5 : _ref$resolutionScale,
        ...
        kernelSize =
          _ref$kernelSize === void 0 ? KernelSize.LARGE : _ref$kernelSize;
      ...
      _this18.resolution = new Resizer(
      ...
      [
        {
          ...
          value: function setMaterial(material) {
            ...
            if (material !== null) {
              ...
              this.materialInstanced.uniforms = Object.assign(
                {},
                material.uniforms
              );
              this.materialSkinning = material.clone();
              this.materialSkinning.uniforms = Object.assign(
                {},
                material.uniforms
              );
  ...
  var RenderPass = (function (_Pass4) {
    ...
    function RenderPass(scene, camera) {
      ...
      _this21.overrideMaterialManager =
    ...
    _createClass(RenderPass, [
      ...
      },
      {
        ...
        get: function get() {
          return _get(
            _getPrototypeOf(RenderPass.prototype),
            'renderToScreen',
            this
          );
        },
  ...
  var DepthPass = (function (_Pass5) {
    ...
    function DepthPass(scene, camera) {
      ...
      var _ref2 =
        ...
        resolutionScale =
          _ref2$resolutionScale === void 0 ? 1.0 : _ref2$resolutionScale,
      ...
      _this22.renderPass = new RenderPass(
        scene,
        camera,
      ...
      _this22.resolution = new Resizer(
  ...
  var DepthDownsamplingPass = (function (_Pass6) {
    ...
    function DepthDownsamplingPass() {
      ...
      var _ref3 =
        ...
        normalBuffer =
          _ref3$normalBuffer === void 0 ? null : _ref3$normalBuffer,
        _ref3$resolutionScale = _ref3.resolutionScale,
        resolutionScale =
          _ref3$resolutionScale === void 0 ? 0.5 : _ref3$resolutionScale,
      ...
      _this23.resolution = new Resizer(
  ...
  var BlendMode = (function (_EventDispatcher) {
    ...
    function BlendMode(blendFunction) {
      ...
      var opacity =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.0;
  ...
  var Effect = (function (_EventDispatcher2) {
    ...
    function Effect(name, fragmentShader) {
      ...
      var _ref4 =
        ...
        attributes =
          _ref4$attributes === void 0 ? EffectAttribute.NONE : _ref4$attributes,
        _ref4$blendFunction = _ref4.blendFunction,
        blendFunction =
          _ref4$blendFunction === void 0
        ...
        vertexShader =
          _ref4$vertexShader === void 0 ? null : _ref4$vertexShader;
  ...
  function integrateEffect(
    ...
    var mainImageExists =
      ...
      shaders.get('fragment').indexOf('mainImage') >= 0;
    var mainUvExists =
      shaders.get('fragment') !== undefined &&
      shaders.get('fragment').indexOf('mainUv') >= 0;
    var varyings = [],
      names = [];
    ...
    if (shaders.get('fragment') === undefined) {
      ...
      mainUvExists &&
      (attributes & EffectAttribute.CONVOLUTION) !== 0
    ) {
      console.error(
      ...
      if (
        ...
        shaders.get('vertex').indexOf('mainSupport') >= 0
      ) {
        ...
        names = names
          .concat(varyings)
          .concat(findSubstrings(functionRegExp, shaders.get('vertex')));
      }

      names = names
        .concat(findSubstrings(functionRegExp, shaders.get('fragment')))
        .concat(
          Array.from(effect.defines.keys()).map(function (s) {
      ...
      if (mainImageExists) {
        ...
        if (
          ...
          shaders.get('fragment').indexOf('depth') >= 0
        ) {
          _string += 'depth, ';
          readDepth = true;
        }
        ...
        shaderParts.set(
          Section.FRAGMENT_MAIN_IMAGE,
          shaderParts.get(Section.FRAGMENT_MAIN_IMAGE) + _string
        );
        shaderParts.set(
          Section.FRAGMENT_HEAD,
          shaderParts.get(Section.FRAGMENT_HEAD) +
  ...
  var EffectPass = (function (_Pass7) {
    ...
    function EffectPass(camera) {
      ...
      _this26.setFullscreenMaterial(
        new EffectMaterial(null, null, null, camera)
      );

      for (
        var _len = arguments.length,
          effects = new Array(_len > 1 ? _len - 1 : 0),
          _key = 1;
        _key < _len;
        _key++
      ) {
    ...
    _createClass(EffectPass, [
              ...
              shaderParts.set(
                ...
                shaderParts.get(Section.FRAGMENT_HEAD) +
                  blendMode
                    ...
                    .replace(
                      blendRegExp,
                      'blend' + blendMode.getBlendFunction()
                    ) +
                  '\n'
              );
            }
        ...
        value: function render(
          ...
          if (!this.skipRendering || this.renderToScreen) {
            ...
            material.uniforms.time.value =
              time <= this.maxTime ? time : this.minTime;
            renderer.setRenderTarget(this.renderToScreen ? null : outputBuffer);
            renderer.render(this.scene, this.camera);
          }
        },
      ...
      },
      {
        key: 'dispose',
        value: function dispose() {
          _get(_getPrototypeOf(EffectPass.prototype), 'dispose', this).call(
            this
          );
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.getFullscreenMaterial().defines.ENCODE_OUTPUT !== undefined
          );
        },
        set: function set(value) {
  ...
  var NormalPass = (function (_Pass9) {
    ...
    function NormalPass(scene, camera) {
      ...
      var _ref5 =
        ...
        resolutionScale =
          _ref5$resolutionScale === void 0 ? 1.0 : _ref5$resolutionScale,
      ...
      _this29.renderPass = new RenderPass(
        scene,
        camera,
      ...
      _this29.resolution = new Resizer(
  ...
  var EffectComposer = (function () {
    function EffectComposer() {
      ...
      var _ref6 =
        ...
        stencilBuffer =
          _ref6$stencilBuffer === void 0 ? false : _ref6$stencilBuffer,
        _ref6$multisampling = _ref6.multisampling,
        multisampling =
          _ref6$multisampling === void 0 ? 0 : _ref6$multisampling,
    ...
    _createClass(Selection, [
      {
        ...
        value: function clear() {
          ...
          return _get(_getPrototypeOf(Selection.prototype), 'clear', this).call(
            this
          );
        },
      },
      ...
      },
      {
        ...
        value: function add(object) {
          ...
          _get(_getPrototypeOf(Selection.prototype), 'add', this).call(
            this,
            object
          );
      ...
      },
      {
        ...
        value: function _delete(object) {
          ...
          return _get(
            _getPrototypeOf(Selection.prototype),
            'delete',
            this
          ).call(this, object);
        },
  ...
  var BloomEffect = (function (_Effect) {
    ...
    function BloomEffect() {
      ...
      var _ref7 =
        ...
        blendFunction =
          _ref7$blendFunction === void 0
            ? BlendFunction.SCREEN
            : _ref7$blendFunction,
        _ref7$luminanceThresh = _ref7.luminanceThreshold,
        luminanceThreshold =
          _ref7$luminanceThresh === void 0 ? 0.9 : _ref7$luminanceThresh,
        _ref7$luminanceSmooth = _ref7.luminanceSmoothing,
        luminanceSmoothing =
          _ref7$luminanceSmooth === void 0 ? 0.025 : _ref7$luminanceSmooth,
        _ref7$resolutionScale = _ref7.resolutionScale,
        resolutionScale =
          _ref7$resolutionScale === void 0 ? 0.5 : _ref7$resolutionScale,
        ...
        kernelSize =
          _ref7$kernelSize === void 0 ? KernelSize.LARGE : _ref7$kernelSize;
  ...
  var ColorDepthEffect = (function (_Effect5) {
    ...
    function ColorDepthEffect() {
      ...
      var _ref10 =
        ...
        blendFunction =
          _ref10$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref10$blendFunction,
  ...
  var ChromaticAberrationEffect = (function (_Effect6) {
    ...
    function ChromaticAberrationEffect() {
      var _ref11 =
        ...
        blendFunction =
          _ref11$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref11$blendFunction,
        _ref11$offset = _ref11.offset,
        offset =
          _ref11$offset === void 0
            ? new three.Vector2(0.001, 0.0005)
            : _ref11$offset;

      _classCallCheck(this, ChromaticAberrationEffect);

      return _super37.call(
        this,
  ...
  var DepthEffect = (function (_Effect7) {
    ...
    function DepthEffect() {
      ...
      var _ref12 =
        ...
        blendFunction =
          _ref12$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref12$blendFunction,
  ...
  var DepthOfFieldEffect = (function (_Effect8) {
    ...
    function DepthOfFieldEffect(camera) {
      ...
      var _ref13 =
        ...
        blendFunction =
          _ref13$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref13$blendFunction,
        _ref13$focusDistance = _ref13.focusDistance,
        focusDistance =
          _ref13$focusDistance === void 0 ? 0.0 : _ref13$focusDistance,
      ...
      _this36.uniforms.get('nearColorBuffer').value =
        _this36.renderTargetNear.texture;
      _this36.renderTargetFar = _this36.renderTarget.clone();
      _this36.renderTargetFar.texture.name = 'DoF.Bokeh.Far';
      _this36.uniforms.get('farColorBuffer').value =
        _this36.renderTargetFar.texture;
      ...
      _this36.uniforms.get('nearCoCBuffer').value =
        _this36.renderTargetCoCBlurred.texture;
      ...
      _this36.maskPass = new ShaderPass(
        new MaskMaterial(_this36.renderTargetCoC.texture)
      );
      ...
      _this36.bokehNearBasePass = new ShaderPass(
        new BokehMaterial(false, true)
      );
      _this36.bokehNearFillPass = new ShaderPass(new BokehMaterial(true, true));
      _this36.bokehFarBasePass = new ShaderPass(
        new BokehMaterial(false, false)
      );
    ...
    _createClass(DepthOfFieldEffect, [
      ...
      },
      {
        ...
        value: function update(renderer, inputBuffer, deltaTime) {
          ...
          var farBaseUniforms = bokehFarBasePass.getFullscreenMaterial()
            .uniforms;
          var farFillUniforms = bokehFarFillPass.getFullscreenMaterial()
            .uniforms;
          var bokehNearBasePass = this.bokehNearBasePass;
          var bokehNearFillPass = this.bokehNearFillPass;
          var nearBaseUniforms = bokehNearBasePass.getFullscreenMaterial()
            .uniforms;
          var nearFillUniforms = bokehNearFillPass.getFullscreenMaterial()
            .uniforms;
          ...
          farBaseUniforms.cocBuffer.value = farFillUniforms.cocBuffer.value =
            renderTargetCoC.texture;
          ...
          nearBaseUniforms.cocBuffer.value = nearFillUniforms.cocBuffer.value =
            renderTargetCoCBlurred.texture;
          bokehNearBasePass.render(renderer, inputBuffer, renderTarget);
          bokehNearFillPass.render(
            renderer,
            renderTarget,
  ...
  var DotScreenEffect = (function (_Effect9) {
    ...
    function DotScreenEffect() {
      ...
      var _ref14 =
        ...
        blendFunction =
          _ref14$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref14$blendFunction,
    ...
    _createClass(DotScreenEffect, [
      {
        ...
        value: function setAngle(angle) {
          this.uniforms
            .get('angle')
            .value.set(Math.sin(angle), Math.cos(angle));
        },
      },
    ]);
  ...
  var GammaCorrectionEffect = (function (_Effect10) {
    ...
    function GammaCorrectionEffect() {
      var _ref15 =
        ...
        blendFunction =
          _ref15$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref15$blendFunction,
    ...
    _createClass(SMAAImageLoader, [
      {
        ...
        value: function load() {
          ...
          return new Promise(function (resolve, reject) {
            var cachedURLs =
              !_this39.disableCache && window.localStorage !== undefined
                ? [
  ...
  function calculateOrthogonalAreaForPattern(
    pattern,
    left,
    right,
    offset,
  ...
  function calculateDiagonalAreaForPattern(
    pattern,
    left,
    right,
    offset,
    ...
    _createClass(SMAAAreaImageData, null, [
      {
        ...
        value: function generate() {
          ...
          var height =
            orthogonalSubsamplingOffsets.length * 5 * ORTHOGONAL_SIZE;
          ...
          for (i = 0; i < 16; ++i) {
            orthogonalPatterns.push(
              new RawImageData(
                ...
                new Uint8ClampedArray(
                  orthogonalPatternSize * orthogonalPatternSize * 2
                ),
                2
              )
            );
            diagonalPatterns.push(
              new RawImageData(
                ...
                diagonalPatternSize,
                new Uint8ClampedArray(
                  diagonalPatternSize * diagonalPatternSize * 2
                ),
                2
              )
            );
    ...
    _createClass(SMAASearchImageData, null, [
      {
        ...
        value: function generate() {
          ...
          var croppedData = new Uint8ClampedArray(
  ...
  var GlitchEffect = (function (_Effect11) {
    ...
    function GlitchEffect() {
      ...
      var _ref16 =
        ...
        blendFunction =
          _ref16$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref16$blendFunction,
        _ref16$chromaticAberr = _ref16.chromaticAberrationOffset,
        chromaticAberrationOffset =
          _ref16$chromaticAberr === void 0 ? null : _ref16$chromaticAberr,
        _ref16$delay = _ref16.delay,
        delay =
          _ref16$delay === void 0 ? new three.Vector2(1.5, 3.5) : _ref16$delay,
        _ref16$duration = _ref16.duration,
        duration =
          _ref16$duration === void 0
            ? new three.Vector2(0.6, 1.0)
            : _ref16$duration,
        _ref16$strength = _ref16.strength,
        strength =
          _ref16$strength === void 0
        ...
        perturbationMap =
          _ref16$perturbationMa === void 0 ? null : _ref16$perturbationMa,
      ...
      _this40.setPerturbationMap(
        perturbationMap === null
          ? _this40.generatePerturbationMap(dtSize)
          : perturbationMap
      );

      _this40.delay = delay;
      _this40.duration = duration;
      _this40.breakPoint = new three.Vector2(
        randomFloat(_this40.delay.x, _this40.delay.y),
        randomFloat(_this40.duration.x, _this40.duration.y)
      );
      _this40.time = 0;
  ...
  var fragmentShader$p =
    'uniform sampler2D texture;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(texture,uv);}';
  ...
  var GodRaysEffect = (function (_Effect12) {
    ...
    function GodRaysEffect(camera, lightSource) {
      ...
      var _ref17 =
        ...
        blendFunction =
          _ref17$blendFunction === void 0
            ? BlendFunction.SCREEN
            : _ref17$blendFunction,
        ...
        resolutionScale =
          _ref17$resolutionScal === void 0 ? 0.5 : _ref17$resolutionScal,
        ...
        kernelSize =
          _ref17$kernelSize === void 0 ? KernelSize.SMALL : _ref17$kernelSize,
      ...
      _this41.renderPassLight.getClearPass().overrideClearColor = new three.Color(
        0x000000
      );
      ...
      _this41.depthMaskPass = new ShaderPass(
      ...
      _this41.godRaysPass = new ShaderPass(
        (function () {
  ...
  var GridEffect = (function (_Effect13) {
    ...
    function GridEffect() {
      ...
      var _ref18 =
        ...
        blendFunction =
          _ref18$blendFunction === void 0
            ? BlendFunction.OVERLAY
            : _ref18$blendFunction,
    ...
    _createClass(GridEffect, [
      ...
      },
      {
        ...
        value: function setSize(width, height) {
          ...
          this.uniforms.get('lineWidth').value =
            scale / height + this.lineWidth;
        },
      },
    ]);
  ...
  var HueSaturationEffect = (function (_Effect14) {
    ...
    function HueSaturationEffect() {
      ...
      var _ref19 =
        ...
        blendFunction =
          _ref19$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref19$blendFunction,
    ...
    _createClass(HueSaturationEffect, [
      {
        ...
        value: function setHue(hue) {
          ...
          this.uniforms
            .get('hue')
            .value.set(2.0 * c, -Math.sqrt(3.0) * s - c, Math.sqrt(3.0) * s - c)
            .addScalar(1.0)
            .divideScalar(3.0);
        },
      },
  ...
  var NoiseEffect = (function (_Effect15) {
    ...
    function NoiseEffect() {
      ...
      var _ref20 =
        ...
        blendFunction =
          _ref20$blendFunction === void 0
            ? BlendFunction.SCREEN
            : _ref20$blendFunction,
        _ref20$premultiply = _ref20.premultiply,
        premultiply =
          _ref20$premultiply === void 0 ? false : _ref20$premultiply;
  ...
  var OutlineEffect = (function (_Effect16) {
    ...
    function OutlineEffect(scene, camera) {
      ...
      var _ref21 =
        ...
        blendFunction =
          _ref21$blendFunction === void 0
            ? BlendFunction.SCREEN
            : _ref21$blendFunction,
        _ref21$patternTexture = _ref21.patternTexture,
        patternTexture =
          _ref21$patternTexture === void 0 ? null : _ref21$patternTexture,
        _ref21$edgeStrength = _ref21.edgeStrength,
        edgeStrength =
          _ref21$edgeStrength === void 0 ? 1.0 : _ref21$edgeStrength,
        ...
        visibleEdgeColor =
          _ref21$visibleEdgeCol === void 0 ? 0xffffff : _ref21$visibleEdgeCol,
        _ref21$hiddenEdgeColo = _ref21.hiddenEdgeColor,
        hiddenEdgeColor =
          _ref21$hiddenEdgeColo === void 0 ? 0x22090a : _ref21$hiddenEdgeColo,
        _ref21$resolutionScal = _ref21.resolutionScale,
        resolutionScale =
          _ref21$resolutionScal === void 0 ? 0.5 : _ref21$resolutionScal,
      ...
      _this45.uniforms.get('maskTexture').value =
        _this45.renderTargetMask.texture;
      ...
      _this45.maskPass = new RenderPass(
        scene,
        camera,
        new DepthComparisonMaterial(_this45.depthPass.texture, camera)
      );
      ...
      _this45.outlinePass.getFullscreenMaterial().uniforms.inputBuffer.value =
        _this45.renderTargetMask.texture;
      _this45.time = 0.0;
  ...
  var RealisticBokehEffect = (function (_Effect18) {
    ...
    function RealisticBokehEffect() {
      ...
      var _ref22 =
        ...
        blendFunction =
          _ref22$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref22$blendFunction,
        ...
        luminanceThreshold =
          _ref22$luminanceThres === void 0 ? 0.5 : _ref22$luminanceThres,
        _ref22$luminanceGain = _ref22.luminanceGain,
        luminanceGain =
          _ref22$luminanceGain === void 0 ? 2.0 : _ref22$luminanceGain,
        ...
        set: function set(value) {
          if (this.manualDoF !== value) {
            if (value) {
              ...
              this.uniforms.get('dof').value = new three.Vector4(
                0.2,
                1.0,
                0.2,
                2.0
  ...
  var ScanlineEffect = (function (_Effect19) {
    ...
    function ScanlineEffect() {
      ...
      var _ref23 =
        ...
        blendFunction =
          _ref23$blendFunction === void 0
            ? BlendFunction.OVERLAY
            : _ref23$blendFunction,
        ...
        value: function update(renderer, inputBuffer, delta) {
          ...
          if (this.active) {
            ...
            if (uniformActive.value) {
              uniforms.get('cameraDistance').value = camera.position.distanceTo(
                epicenter
              );
  ...
  var SelectiveBloomEffect = (function (_BloomEffect) {
    ...
    function SelectiveBloomEffect(scene, camera, options) {
      ...
      _this50.blackoutPass = new RenderPass(
        scene,
        camera,
    ...
    _createClass(SelectiveBloomEffect, [
      {
        ...
        value: function update(renderer, inputBuffer, deltaTime) {
          ...
          _get(
            _getPrototypeOf(SelectiveBloomEffect.prototype),
            'update',
            this
          ).call(this, renderer, renderTarget, deltaTime);
        },
      },
      {
        key: 'setSize',
      ...
      },
      {
        ...
        value: function initialize(renderer, alpha, frameBufferType) {
          _get(
            ...
            'initialize',
            this
          ).call(this, renderer, alpha, frameBufferType);
  ...
  var SepiaEffect = (function (_Effect21) {
    ...
    function SepiaEffect() {
      var _ref25 =
        ...
        blendFunction =
          _ref25$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref25$blendFunction,
  ...
  var SMAAEffect = (function (_Effect22) {
    ...
    function SMAAEffect(searchImage, areaImage) {
      ...
      _this51.uniforms.get('weightMap').value =
        _this51.renderTargetWeights.texture;
      ...
      _this51.edgeDetectionPass = new ShaderPass(
      ...
      [
        ...
        },
        {
          ...
          value: function setSize(width, height) {
            ...
            weightsMaterial.uniforms.texelSize.value.set(
              1.0 / width,
              1.0 / height
            );
        ...
        },
        {
          ...
          value: function dispose() {
            ...
            _get(_getPrototypeOf(SMAAEffect.prototype), 'dispose', this).call(
              this
            );
          },
        },
  ...
  var SSAOEffect = (function (_Effect23) {
    ...
    function SSAOEffect(camera, normalBuffer) {
      ...
      var _ref26 =
        ...
        blendFunction =
          _ref26$blendFunction === void 0
            ? BlendFunction.MULTIPLY
            : _ref26$blendFunction,
        _ref26$distanceScalin = _ref26.distanceScaling,
        distanceScaling =
          _ref26$distanceScalin === void 0 ? true : _ref26$distanceScalin,
        _ref26$depthAwareUpsa = _ref26.depthAwareUpsampling,
        depthAwareUpsampling =
          _ref26$depthAwareUpsa === void 0 ? true : _ref26$depthAwareUpsa,
        _ref26$normalDepthBuf = _ref26.normalDepthBuffer,
        normalDepthBuffer =
          _ref26$normalDepthBuf === void 0 ? null : _ref26$normalDepthBuf,
        ...
        distanceThreshold =
          _ref26$distanceThresh === void 0 ? 0.97 : _ref26$distanceThresh,
        _ref26$distanceFallof = _ref26.distanceFalloff,
        distanceFalloff =
          _ref26$distanceFallof === void 0 ? 0.03 : _ref26$distanceFallof,
        _ref26$rangeThreshold = _ref26.rangeThreshold,
        rangeThreshold =
          _ref26$rangeThreshold === void 0 ? 0.0005 : _ref26$rangeThreshold,
        _ref26$rangeFalloff = _ref26.rangeFalloff,
        rangeFalloff =
          _ref26$rangeFalloff === void 0 ? 0.001 : _ref26$rangeFalloff,
        _ref26$minRadiusScale = _ref26.minRadiusScale,
        minRadiusScale =
          _ref26$minRadiusScale === void 0 ? 0.33 : _ref26$minRadiusScale,
        _ref26$luminanceInflu = _ref26.luminanceInfluence,
        luminanceInfluence =
          _ref26$luminanceInflu === void 0 ? 0.7 : _ref26$luminanceInflu,
        ...
        resolutionScale =
          _ref26$resolutionScal === void 0 ? 1.0 : _ref26$resolutionScal,
      ...
      _this52.resolution = new Resizer(
        _assertThisInitialized(_this52),
        width,
        height,
        resolutionScale
      );
      ...
      _this52.ssaoPass = new ShaderPass(
        (function () {
          ...
          if (normalDepthBuffer !== null) {
            ...
            if (depthAwareUpsampling) {
              ...
              _this52.uniforms.get(
                'normalDepthBuffer'
              ).value = normalDepthBuffer;
    ...
    _createClass(SSAOEffect, [
      ...
      },
      {
        ...
        value: function setSize(width, height) {
          ...
          uniforms.inverseProjectionMatrix.value.getInverse(
  ...
  var TextureEffect = (function (_Effect24) {
    ...
    function TextureEffect() {
      ...
      var _ref27 =
        ...
        blendFunction =
          _ref27$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref27$blendFunction,
        ...
        aspectCorrection =
          _ref27$aspectCorrecti === void 0 ? false : _ref27$aspectCorrecti;
  ...
  var ToneMappingEffect = (function (_Effect25) {
    ...
    function ToneMappingEffect() {
      ...
      var _ref28 =
        ...
        blendFunction =
          _ref28$blendFunction === void 0
            ? BlendFunction.NORMAL
            : _ref28$blendFunction,
        ...
        maxLuminance =
          _ref28$maxLuminance === void 0 ? 16.0 : _ref28$maxLuminance,
        _ref28$averageLuminan = _ref28.averageLuminance,
        averageLuminance =
          _ref28$averageLuminan === void 0 ? 1.0 : _ref28$averageLuminan,
        _ref28$adaptationRate = _ref28.adaptationRate,
        adaptationRate =
          _ref28$adaptationRate === void 0 ? 2.0 : _ref28$adaptationRate;
      ...
      _this54.renderTargetPrevious.texture.name =
      ...
      _this54.adaptiveLuminancePass = new ShaderPass(
        new AdaptiveLuminanceMaterial()
      );

      var uniforms = _this54.adaptiveLuminancePass.getFullscreenMaterial()
        .uniforms;

      uniforms.previousLuminanceBuffer.value =
        _this54.renderTargetPrevious.texture;
      uniforms.currentLuminanceBuffer.value =
        _this54.renderTargetLuminance.texture;
    ...
    _createClass(ToneMappingEffect, [
        ...
        value: function update(renderer, inputBuffer, deltaTime) {
          if (this.adaptive) {
            this.luminancePass.render(
              renderer,
              inputBuffer,
              this.renderTargetLuminance
            );
            var uniforms = this.adaptiveLuminancePass.getFullscreenMaterial()
              .uniforms;
      ...
      },
      {
        key: 'adaptationRate',
        get: function get() {
          return this.adaptiveLuminancePass.getFullscreenMaterial().uniforms.tau
            .value;
        },
        set: function set(value) {
