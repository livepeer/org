  ...
  },
  {
    ...
    listItems: [
      ...
      <Box>
        ...
        Affordable transcoding powered by the public network allows you to
        operate a UGC platform with millions of content creators.
      </Box>,
      <Box>
        <Text
          sx={{
        ...
        Content moderation APIs necessary in running UGC platforms, such as
        automatically flagging adult content.
      </Box>,
    ],
    cta: {
